                        ...
                        <>
                            <div className="modern-profile p-3 pb-0">
                                <div className="sidebar-nav mb-3">
                                    ...
                                    >
                                        ...
                                        <li className="nav-item">
                                            <Link className="nav-link border-0" to={allroutes.chat}>
                                                Chats
                                            </Link>
                                        </li>
                                        <li className="nav-item">
                                            <Link className="nav-link border-0" to={allroutes.email}>
                                                Inbox
                                            </Link>
                                        </li>
                                    </ul>
                            ...
                            <div className="sidebar-header p-3 pb-0 pt-2">
                                <div className="d-flex align-items-center justify-content-between menu-item mb-3">
                                    <div className="me-3">
                                        <Link to={allroutes.calendar} className="btn btn-icon border btn-menubar">
                                    ...
                                    <div className="me-0">
                                        <Link to={allroutes.email} className="btn btn-icon border btn-menubar">
                            ...
                            <ul>
                                {SidebarData?.map((mainLabel, index) => (
                                    <li className="clinicdropdown" key={index}>
                                        ...
                                        <ul>
                                            {mainLabel?.submenuItems?.map((title: any, _i) => {
                                                let link_array: any = [];
