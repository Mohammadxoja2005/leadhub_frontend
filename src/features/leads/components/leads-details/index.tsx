...
import {
    ...
    LocaleData,
    statusList
} from "../selectoption/selectoption.ts";
import {SelectWithImage2} from "../select-with-image-2";

const route = allroutes;
const LeadsDetails = () => {
    // const data = leadsData;
    // const [_addcomment, _setAddComment] = useState(false);
    // const togglecomment = () => {
    //     setAddComment((prevState) => !prevState);
    // };
    const [_stars, setStars] = useState<{ [key: number]: boolean }>({});

    const initializeStarsState = () => {
        const starsState: { [key: number]: boolean } = {};
        leadsData.forEach((_item, index) => {
                                    ...
                                    <div className="tab-pane active show" id="activities">
                                        <div className="card">
                                            ...
                                            <div className="card-body">
                                                <div
                                                    className="badge badge-soft-purple fs-14 fw-normal shadow-none mb-3">
                                        ...
                                        <div className="card">
                                            ...
                                            <div className="card-body">
                                                <div className="card mb-3">
                                                    <div className="card-body">
                                                        <div
                                                            className="d-sm-flex align-items-center justify-content-between pb-2">
                                                            <div className="d-flex align-items-center mb-2">
                              <span className="avatar avatar-md me-2 flex-shrink-0">
                                <ImageWithBasePath
                                    src="assets/img/profiles/avatar-19.jpg"
                              ...
                              <span className="avatar avatar-md me-2 flex-shrink-0">
                                ...
                                <span className="badge badge-danger-light me-1">
                                  Proposal
                                                                    ...
                                                                    <span
                                                                        className="badge bg-pending priority-badge me-1">
                                  Draft
                                </span>
                                                                    <div className="dropdown">
                                                                        <Link
                                                                ...
                                                                <div className="sign-content">
                                                                    <div className="row">
                                                                        ...
                                                                        <div className="col-md-6">
                                                                            <div className="d-flex align-items-center">
                                                                                <div
                                                                                    className="float-none mb-3 me-3 w-100">
                                                                                    <input
                                                                                        className="form-control"
                                                                                        type="text"
