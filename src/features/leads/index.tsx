...
const Leads = () => {
    ...
    const [show3, _setShow3] = useState(false);
    ...
    const columns = [
        ...
        },
        {
            ...
            key: "lead_name",
            render: (text: any) => (
                <p to={route.leadsDetails} className="title-name">
                    {text}
                </p>
            ),
                          ...
                          <span className="form-icon">
                            <i className="ti ti-search"/>
                                            ...
                                            <div className="col-sm-8">
                                                <div
                                                    className="d-flex align-items-center flex-wrap row-gap-2 justify-content-sm-end">
                                    ...
                                    <div className="card-body">
                                        {/* Filter */}
                                        {/*              <div*/}
                                        {/*                  className="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">*/}
                                        ...
                                        {/*/!*</span>*!/*/}
                                        {/*                          /!*<DatePicker initialSettings={initialSettings}>*!/*/}
                                        {/*                          /!*    <input*!/*/}
                                        ...
                                        {/*              /!*            </Link>*!/*/}
                                        {/*              /!*            <div*!/*/}
                                        {/*              /!*                className="filter-dropdown-menu dropdown-menu  dropdown-menu-md-end p-3">*!/*/}
                    ...
                    <div className="modal-body">
                        <div className="success-message text-center">
                            ...
                            <div className="col-lg-12 text-center modal-btn">
                                ...
                                <Link to={route.leadsDetails} onClick={() => setOpenModal2(false)}
                                      className="btn btn-primary">
                                    View Details
                                </Link>
                            </div>
                    ...
                    <div className="modal-body">
                        <div className="success-message text-center">
                            ...
                            <div className="col-lg-12 text-center modal-btn">
                                ...
                                <Link to={route.companyDetails} onClick={() => setOpenModal(false)}
                                      className="btn btn-primary">
                                    View Details
                                </Link>
                            </div>
