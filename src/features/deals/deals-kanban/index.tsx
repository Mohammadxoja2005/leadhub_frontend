                    ...
                    <div className="content">
                        <div className="row">
                            <div className="col-md-12">
                                ...
                                {/* Filter */}
                                <div
                                    className="d-flex justify-content-between align-items-center flex-wrap row-gap-2 mb-4">
                                    <div className="d-flex align-items-center flex-wrap row-gap-2">
                                        <div className="form-sorts dropdown me-2">
                                            ...
                                            <div
                                                className="filter-dropdown-menu dropdown-menu  dropdown-menu-md-start p-3">
